...
http://joomlawatchdemo.com/wordpress/
http://joomlawatchdemo.com/wordpress/wp-admin/ user: admin, pass: demo
...
The functionality of PRO version should be more or less the same as one for Joomla.
